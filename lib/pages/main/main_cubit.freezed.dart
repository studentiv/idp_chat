...
abstract class $MainStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool loading, bool? isAuthorized, ChatUser? user});
}
...
class _$_MainState implements _MainState {
  const _$_MainState({this.loading = true, this.isAuthorized, this.user});
  ...
  @override
  String toString() {
    return 'MainState(loading: $loading, isAuthorized: $isAuthorized, user: $user)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loading, isAuthorized, user);
...
abstract class _MainState implements MainState {
  const factory _MainState(
      {final bool loading,
      final bool? isAuthorized,
      final ChatUser? user}) = _$_MainState;
